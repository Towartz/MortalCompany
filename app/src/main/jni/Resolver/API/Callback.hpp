...
namespace IL2CPP
{
	...
	namespace Callback
	{
		...
		inline void Initialize()
		{
			...
			{
#ifdef __aarch64__
				OnUpdate::m_CallbackHook.m_VFunc		= Utils::VTable::FindFunction(m_MonoBehaviourVTable, 99, { 0x02, 0x00, 0x80, 0xD2, 0x00, 0x00, 0x00, 0x14 });
				OnLateUpdate::m_CallbackHook.m_VFunc	= Utils::VTable::FindFunction(m_MonoBehaviourVTable, 99, { 0x22, 0x00, 0x80, 0xD2, 0x00, 0x00, 0x00, 0x14 });
#elif __arm__
				OnUpdate::m_CallbackHook.m_VFunc		= Utils::VTable::FindFunction(m_MonoBehaviourVTable, 99, { 0x00, 0x20, 0xA0, 0xE3, 0x00, 0x00, 0x00, 0xEA });
				OnLateUpdate::m_CallbackHook.m_VFunc	= Utils::VTable::FindFunction(m_MonoBehaviourVTable, 99, { 0x01, 0x20, 0xA0, 0xE3, 0x00, 0x00, 0x00, 0xEA });
#endif
			}
