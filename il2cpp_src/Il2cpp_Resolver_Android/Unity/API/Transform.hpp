...
namespace Unity
{
    ...
    namespace Transform
    {
        inline void Initialize()
        {
            ...
            m_TransformFunctions.m_GetForward        = IL2CPP::ResolveCall(UNITY_TRANSFORM_GETFORWARD);
            ...
            m_TransformFunctions.m_SetForward        = IL2CPP::ResolveCall(UNITY_TRANSFORM_SETFORWARD);
